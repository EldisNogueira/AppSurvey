      ...
      radioButtons: [
        {
          ...
          checked: true, color: '#000000',
          disabled: false, flexDirection: 'row', size: 10
        },
        {
          label: 'Pesquisador', value: 'Pesq',
          checked: false, color: '#000000',
          disabled: false, flexDirection: 'row', size: 10
        },
      ]
    }
    ...
    return (
      <View style={estilo.contView}>
        ...
        <View style={estilo.contViewInput}>
          <TextInput style={estilo.inputTexts}
            placeholder="USUÁRIO"
          ...
          <View style={{ width: "100%", flexDirection: "row", alignItems: "center" }}>
            <View style={{ width: "45%", height: "1%", borderWidth: 1, borderColor: "#DCDCDC" }}></View>
...
const estilo = StyleSheet.create({
  contView: {
    ...
    justifyContent: "flex-start", padding: 20, alignItems: "center"
  },

  titleLogo: { marginTop: 20, alignItems: "center", fontSize: 35, fontWeight: "bold" },
  titleSub: { alignItems: "center", fontSize: 14, marginLeft: 60, },

  contViewInput: {
    flex: 1, flexDirection: "column", justifyContent: "flex-start",
    width: "100%", height: "100%",
    paddingLeft: 10, paddingTop: 20, paddingRight: 10,
  },

  inputTexts: { marginTop: 5, padding: 10, borderWidth: 2, borderColor: "#0AA363", borderRadius: 10 },

  containerButtomEnviar: {
    width: "100%", height: "12%", backgroundColor: "#0AA363", borderRadius: 5,
